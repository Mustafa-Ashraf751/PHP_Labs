        ...
        <div class="container-card">
            ...
            <div class="result-section">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="data-item">
                            ...
                            <div class="data-value"><?php echo $formdata['lastName'] ?></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="data-item">
                ...
                <div class="data-item">
                    ...
                    <div class="data-value"><?php echo $formdata['address'] ?></div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="data-item">
                            ...
                            <div class="data-value"><?php echo $formdata['country'] ?></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="data-item">
                            ...
                            <div class="data-value">
                                <i class="bi bi-gender-male"></i> <?php echo $formdata['gender'] ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="result-section">
                ...
                <div class="data-item">
                    ...
                    <div class="data-value"> <?php echo $formdata['department'] ?></div>
                </div>
            </div>
            ...
            <div class="result-section">
                ...
                <div class="data-item">
                    ...
                    <div class="data-value"><?php echo $formdata['username'] ?></div>
                </div>

                <div class="data-item">
                    <div class="data-label">Password</div>
                    <div class="data-value"><?php echo $formdata['password'] ?></div>
                </div>
